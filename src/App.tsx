...
import DeployN8NPage from "@/pages/DeployN8NPage";  // halaman deploy per service (baru)
          ...
          <AuthProvider>
            <Routes>
              ...
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/services/deploy"  element={<DeployN8NPage />} />  {/* ✅ BARU */}
                ...
                <Route path="/settings"  element={<SettingsPage />} />           {/* ✅ BARU */}
